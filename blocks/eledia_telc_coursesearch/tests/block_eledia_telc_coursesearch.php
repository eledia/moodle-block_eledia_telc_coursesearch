...
final class eledia_telc_coursesearch_test extends \advanced_testcase {
    ...
    public function test_get_block_config_for_external(): void {
        ...
        set_config('displaygroupingcustomfield', 1, 'block_eledia_telc_coursesearch');
        set_config('customfiltergrouping', $field->get('shortname'), 'block_eledia_telc_coursesearch');
        ...
        foreach ($blocks as $region => $regionblocks) {
            ...
            foreach ($regioninstances as $ri) {
                // Look for eledia_telc_coursesearch block only.
                if ($ri->instance->blockname == 'eledia_telc_coursesearch') {
        ...
        $this->assertEquals(get_config('block_eledia_telc_coursesearch', 'version'), $configs->plugin->version);
        // Test custom fields.
